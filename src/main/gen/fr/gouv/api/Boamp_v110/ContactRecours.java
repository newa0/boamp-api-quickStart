...
/**
 * <p>Classe Java pour ContactRecours complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="ContactRecours"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ContactRecours", propOrder = {
    "acheteurAndNOMAndADRESSE"
})
public class ContactRecours {
    ...
    protected List<JAXBElement<String>> acheteurAndNOMAndADRESSE;

    /**
     * Gets the value of the acheteurAndNOMAndADRESSE property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the acheteurAndNOMAndADRESSE property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getACHETEURAndNOMAndADRESSE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<String>> getACHETEURAndNOMAndADRESSE() {
        if (acheteurAndNOMAndADRESSE == null) {
            acheteurAndNOMAndADRESSE = new ArrayList<JAXBElement<String>>();
        }
        return this.acheteurAndNOMAndADRESSE;
    }
